...
zratio1_1_grid = zratio2_1_grid = numpy.array(stats.norm.cdf(numpy.linspace(-1.2, 1.2, 41), scale = .5), dtype = numpy.float32)
...
def TB_par(i):
    ...
    return out
value_TB = Parallel(n_jobs=48)(delayed(TB_par)(i) for i in range(len(points_TB_tau_grid)))
