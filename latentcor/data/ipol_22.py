...
zratio1_1_grid = zratio2_1_grid = numpy.array(stats.norm.cdf(numpy.linspace(.1, 2.5, 50)) * 2 - 1, dtype = numpy.float32)
...
def TT_par(i):
    ...
    return out
value_TT = Parallel(n_jobs=96)(delayed(TT_par)(i) for i in range(len(points_TT_tau_grid)))
