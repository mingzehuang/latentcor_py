...
tau_grid = numpy.array(stats.norm.cdf(numpy.linspace(-1.8, 1.8, 50), scale = .5) * 2 - 1, dtype = numpy.float32)
zratio1_1_grid = zratio1_2_grid = zratio2_1_grid = numpy.array(stats.norm.cdf(numpy.linspace(-1.8, 1.8, 25), scale = .8), dtype = numpy.float32)
