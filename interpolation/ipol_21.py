...
def TB_value(tau, zratio1_1, zratio2_1):
    ...
    tau = tau * latentcor.r_switch.bound_switch(self = latentcor.r_switch, comb = "21", zratio1 = zratio1, zratio2 = zratio2)
    output = latentcor.r_sol.batch(self = latentcor.r_sol, K = tau, comb = "21", zratio1 = zratio1, zratio2 = zratio2, tol = 1e-8)
    return output
